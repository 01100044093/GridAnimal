...
public class ContextualUndoGridViewTouchListener implements View.OnTouchListener {
    ...
    public ContextualUndoGridViewTouchListener(GridView listView, Callback callback) {
